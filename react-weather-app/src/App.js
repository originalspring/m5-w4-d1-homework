...
countries.registerLocale(require('i18n-iso-countries/lang/en.json'));
...
function App() {
  ...
  const apiUrl = `https://home.openweathermap.org/data/2.5/weather?q=${state}&appid=${apiKey}`
  ...
  return (
    <div className="App">
      ...
      <div className="container">
        <div className='mt-3 d-flex flex-colum justify-content-center align-items-center'></div>
          <div class="col-auto">
                ...
                <p>
                 ...
                 <p>
                  <FontAwesomeIcon
                    ...
                    {''}
                    <strong>
                      {kelvinToFarenheit(apiData.main.temp_man)}&deg;F
                    </strong>
                </p>
